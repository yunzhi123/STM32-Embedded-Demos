...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg TIM_SlaveMode_Disable: Slave mode disabled. 
  *     @arg TIM_SlaveMode_EncoderMode1: Encoder mode 1, counter counters up/down on TI1FP1 edge
  *                                      depending on TI2FP2 level. 
  *     @arg TIM_SlaveMode_EncoderMode2: Encoder mode 1, counter counters up/down on TI2FP2 edge
  *                                      depending on TI1FP1 level. 
  *     @arg TIM_SlaveMode_EncoderMode3: Counter counts up/down on both TI1FP1 and TI2FP2 edges 
