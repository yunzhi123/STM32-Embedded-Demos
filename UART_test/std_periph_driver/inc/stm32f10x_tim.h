...
/** @defgroup TIM_Slave_Mode 
  * @{
  */
#define TIM_SlaveMode_Disable              ((uint16_t)0x0000)
#define TIM_SlaveMode_EncoderMode1         ((uint16_t)0x0001)
#define TIM_SlaveMode_EncoderMode2         ((uint16_t)0x0002)
#define TIM_SlaveMode_EncoderMode3         ((uint16_t)0x0003)
#define TIM_SlaveMode_Reset                ((uint16_t)0x0004)
#define TIM_SlaveMode_Gated                ((uint16_t)0x0005)
#define TIM_SlaveMode_Trigger              ((uint16_t)0x0006)
#define TIM_SlaveMode_External1            ((uint16_t)0x0007)
#define IS_TIM_SLAVE_MODE(MODE) (((MODE) == TIM_SlaveMode_Disable) || \
                                 ((MODE) == TIM_SlaveMode_EncoderMode1) || \
                                 ((MODE) == TIM_SlaveMode_EncoderMode2) || \
                                 ((MODE) == TIM_SlaveMode_EncoderMode3) || \
